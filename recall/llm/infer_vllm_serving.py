...
#            top_p=0.1
        ...
        #final_res = raw_res.split("</think>")[-1].replace("\n", "")
        #reasoning = raw_res.split("</think>")[0]
        #print("res:")
        #print(content)
        print(len(tokenizer(reasoning_content)["input_ids"]))
        #print("reasoning:")
...
def main():
    ...
    with ThreadPoolExecutor(max_workers=128) as executor:
        raw_preds = list(executor.map(send_request, prompts))
#        for x in preds:
#            print(x)
