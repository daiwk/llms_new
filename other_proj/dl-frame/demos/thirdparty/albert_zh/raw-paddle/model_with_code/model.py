...
def x2paddle_net():
    IteratorV2 = [0] * 5
    IteratorV2[0] = fluid.layers.data(dtype='int32', shape=[64, 128], name='IteratorV2_0', append_batch_size=False)
    ...
    IteratorV2[4] = fluid.layers.data(dtype='int32', shape=[64, 128], name='IteratorV2_4', append_batch_size=False)
    ...
    bert_encoder_Reshape = fluid.layers.reshape(IteratorV2[1], shape=[64, 1, 128])
    ...
    bert_embeddings_Reshape_3 = fluid.layers.reshape(bert_embeddings_MatMul_1, shape=[64, 128, 312])
    ...
    bert_embeddings_Reshape_1 = fluid.layers.reshape(bert_embeddings_MatMul, shape=[64, 128, 312])
    ...
    bert_encoder_layer_shared_attention_self_Reshape = fluid.layers.reshape(bert_encoder_layer_shared_attention_self_query_BiasAdd, shape=[64, 128, 12, 26])
    bert_encoder_layer_shared_attention_self_Reshape_1 = fluid.layers.reshape(bert_encoder_layer_shared_attention_self_key_BiasAdd, shape=[64, 128, 12, 26])
    bert_encoder_layer_shared_attention_self_Reshape_2 = fluid.layers.reshape(bert_encoder_layer_shared_attention_self_value_BiasAdd, shape=[64, 128, 12, 26])
    ...
    bert_encoder_layer_shared_attention_self_Reshape_3 = fluid.layers.reshape(bert_encoder_layer_shared_attention_self_transpose_3, shape=[8192, 312])
    ...
    bert_encoder_layer_shared_1_attention_self_Reshape = fluid.layers.reshape(bert_encoder_layer_shared_1_attention_self_query_BiasAdd, shape=[64, 128, 12, 26])
    bert_encoder_layer_shared_1_attention_self_Reshape_1 = fluid.layers.reshape(bert_encoder_layer_shared_1_attention_self_key_BiasAdd, shape=[64, 128, 12, 26])
    bert_encoder_layer_shared_1_attention_self_Reshape_2 = fluid.layers.reshape(bert_encoder_layer_shared_1_attention_self_value_BiasAdd, shape=[64, 128, 12, 26])
    ...
    bert_encoder_layer_shared_1_attention_self_Reshape_3 = fluid.layers.reshape(bert_encoder_layer_shared_1_attention_self_transpose_3, shape=[8192, 312])
    ...
    bert_encoder_layer_shared_2_attention_self_Reshape = fluid.layers.reshape(bert_encoder_layer_shared_2_attention_self_query_BiasAdd, shape=[64, 128, 12, 26])
    bert_encoder_layer_shared_2_attention_self_Reshape_1 = fluid.layers.reshape(bert_encoder_layer_shared_2_attention_self_key_BiasAdd, shape=[64, 128, 12, 26])
    bert_encoder_layer_shared_2_attention_self_Reshape_2 = fluid.layers.reshape(bert_encoder_layer_shared_2_attention_self_value_BiasAdd, shape=[64, 128, 12, 26])
    ...
    bert_encoder_layer_shared_2_attention_self_Reshape_3 = fluid.layers.reshape(bert_encoder_layer_shared_2_attention_self_transpose_3, shape=[8192, 312])
    ...
    bert_encoder_layer_shared_3_attention_self_Reshape = fluid.layers.reshape(bert_encoder_layer_shared_3_attention_self_query_BiasAdd, shape=[64, 128, 12, 26])
    bert_encoder_layer_shared_3_attention_self_Reshape_1 = fluid.layers.reshape(bert_encoder_layer_shared_3_attention_self_key_BiasAdd, shape=[64, 128, 12, 26])
    bert_encoder_layer_shared_3_attention_self_Reshape_2 = fluid.layers.reshape(bert_encoder_layer_shared_3_attention_self_value_BiasAdd, shape=[64, 128, 12, 26])
    ...
    bert_encoder_layer_shared_3_attention_self_Reshape_3 = fluid.layers.reshape(bert_encoder_layer_shared_3_attention_self_transpose_3, shape=[8192, 312])
    ...
    bert_encoder_Reshape_5 = fluid.layers.reshape(bert_encoder_layer_shared_3_output_LayerNorm_batchnorm_add_1, shape=[64, 128, 312])
...
def run_net(param_dir="./"):
    ...
    # 重新导出为inference模型
    fluid.io.save_inference_model(dirname='../../albert_paddle_infer_model', feeded_var_names=[ipt.name for ipt in inputs], 
