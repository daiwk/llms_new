...
def repeated_test(_repeated_best_reward, n_test, behavior_pol):
    ...
    for i_th in range(n_test):
        ...
        for t in range(_time_horizon):
            ...
            action_id_tr = form_max_q_feed_dict(sim_vali_user, states)
    ...
    filename = 'DQN'+str(_k)+'_'+str(_noclick_weight)+'.pickle'
...
if __name__ == '__main__':
    ...
    vali_path = save_dir + '/DQN'+str(_k)+'u'+str(_noclick_weight)+'/'
    saver = tf.train.Saver(max_to_keep=None)
