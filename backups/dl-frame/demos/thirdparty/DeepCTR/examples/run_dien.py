...
def get_xy_fd(use_neg=False, hash_flag=False):
    ...
    feature_columns += [VarLenSparseFeat('hist_item',maxlen=4,vocabulary_size=3+1,embedding_dim=8,  embedding_name='item',length_name="seq_length1"),
                        VarLenSparseFeat('hist_item_gender', maxlen=4,vocabulary_size=3+1,embedding_dim=4, embedding_name='item_gender',length_name="seq_length2")]
    ...
    if use_neg:
        ...
        feature_columns += [VarLenSparseFeat('neg_hist_item', maxlen=4,vocabulary_size=3+1,embedding_dim=8, embedding_name='item',length_name="seq_length3"),
