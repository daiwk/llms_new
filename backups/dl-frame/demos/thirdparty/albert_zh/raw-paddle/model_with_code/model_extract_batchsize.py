...
def x2paddle_net():
    ...
    return [IteratorV2], [bert_pooler_dense_Tanh]
...
def run_net(param_dir="./"):
    ...
    # 重新导出为inference模型
    fluid.io.save_inference_model(dirname='../../albert_paddle_infer_model_extract_with_batchsize', feeded_var_names=[ipt.name for ipt in inputs], 
